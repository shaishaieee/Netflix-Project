    ...
    <div className='fixed top-0 left-0 isolate w-full h-screen'>
        ...
        <main className='max-w-[700px] w-full bg-[#141414] text-white absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999] max-h-[900px] h-full'>
            ...
            <div className='relative'>
                    <img src={`${baseImgUrl}/movie/${movieData.image}`} alt="" className='opacity-80 w-full w-[700px] h-[300px]' />
            ...
            <div className='h-[250px] overflow-auto px-4'>
            <div className='grid grid-cols-3 gap-2 max-h-[500px] overflow-auto h-full custom-scroll'>
